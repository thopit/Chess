...
public class ChessPanel extends JPanel implements GameChangedListener {
	...
	public ChessPanel(GameLogic logic) {
        ...
        try {
        	ImageIcon image = new ImageIcon(this.getClass().getResource("/chess/res/field_White.png"));
        	field_White = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/field_Black.png"));
        	field_Black = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/pawn_White_0.png"));
        	pawn_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/pawn_White_1.png"));
        	pawn_White[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/rook_White_0.png"));
        	rook_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/rook_White_1.png"));
        	rook_White[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/knight_White_0.png"));
        	knight_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/knight_White_1.png"));
        	knight_White[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/bishop_White_0.png"));
        	bishop_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/bishop_White_1.png"));
        	bishop_White[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/queen_White_0.png"));
        	queen_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/queen_White_1.png"));
        	queen_White[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/king_White_0.png"));
        	king_White[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/king_White_1.png"));
        	king_White[1] = image.getImage();
        	
        	
        	image = new ImageIcon(this.getClass().getResource("/chess/res/pawn_Black_0.png"));
        	pawn_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/pawn_Black_1.png"));
        	pawn_Black[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/rook_Black_0.png"));
        	rook_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/rook_Black_1.png"));
        	rook_Black[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/knight_Black_0.png"));
        	knight_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/knight_Black_1.png"));
        	knight_Black[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/bishop_Black_0.png"));
        	bishop_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/bishop_Black_1.png"));
        	bishop_Black[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/queen_Black_0.png"));
        	queen_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/queen_Black_1.png"));
        	queen_Black[1] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/king_Black_0.png"));
        	king_Black[0] = image.getImage();
        	image = new ImageIcon(this.getClass().getResource("/chess/res/king_Black_1.png"));
